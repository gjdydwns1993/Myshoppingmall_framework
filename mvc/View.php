<?php
	...
	class View{
		//view 파일의 폴더 경로 정보
		// ex) C:\php\xampp\htdocs\weblog.localhost/views
		protected $_bashURL;
		...
		public function render($filename,$parameters=array(),$template=false){
			//ex)C:\php\xampp\htdocs\weblog.localhost/views/account/signin.php
			...
			if($template){
				//재귀호출
				//재귀호출시에 $template 변수는 null로 초기화
				//ex)C:\php\xampp\htdocs\weblog.localhost/views/template.php
