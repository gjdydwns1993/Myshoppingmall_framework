...
class Request{
  ...
  public function getPath() {
    ...
    // URL : http://weblog.localhost/index_error.php/account/signin
    // request URL : /index_error.php/account/signup
    // path : /account/signup
